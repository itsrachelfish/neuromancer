...
=======
        var to_say = from + ": " + color.yellow('"' + entry.mes + '"') + ' [' + color.red(entry.from) + '] ' + '[' + color.green(tell.readable_time(Date.now() - entry.when)) + ']';
>>>>>>> f150fa390549c31885aa63f1e602ce8001437f15
